...
from dlecosys.shared.training.callbacks import EarlyStopping, ModelCheckpoint
...
from dlecosys.shared.training.panel_preprocess import train_panel_path, val_panel_path
...
def _run_distributed(cfg: PanelPipelineConfig) -> Path:
    from dlecosys.shared.training.panel_distributed import PanelDistributedTrainer
    from dlecosys.shared.training.process_group import is_main_process, setup, teardown
